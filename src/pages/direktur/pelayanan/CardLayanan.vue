    ...
    <q-card-section >
      ...
      <div class="row items-center justify-between q-pb-sm">
        ...
        <div class="text-right">
          ...
          <div >
            <div class="f-14 ">Jumlah Tempat Tidur</div>
          </div>
        </div>
      </div>
    </q-card-section>
      ...
      <q-list padding>
        <q-item >
          <q-item-section avatar>
            <q-avatar rounded size="40px" font-size="34px" color="grey-4" text-color="negative" icon="local_hotel" />
          </q-item-section>
          <q-item-section>
            <q-item-label class="f-18 text-negative">Terisi</q-item-label>
          </q-item-section>
          <q-item-section side>
        ...
        <q-item >
          <q-item-section avatar>
            <q-avatar rounded size="40px" font-size="34px" color="grey-4" text-color="primary" icon="bed" />
          </q-item-section>
          <q-item-section>
            <q-item-label class="f-18 text-primary">Tersedia</q-item-label>
          </q-item-section>
          <q-item-section side>
...
$bg: v-bind(getPaletteColor(color));
