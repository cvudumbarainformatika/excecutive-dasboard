<template>
  <!-- <q-scroll-area class="fit" > -->
    <div class="my-panel">
      <q-scroll-area :style="`height:${panelHeight}px`" >
    <div class="row q-col-gutter-md">
      ...
      <!-- KARTU KESIMPULAN PERBULAN -->
      <div class="col-md-2 col-lg-2 col-xl-2 col-sm-12 col-xs-12">
        <div class="txt-lg text-weight-bold">Indicator Performance</div>

        <!-- <div class="row items-center mt-lg">
          <div class="w-lg h-lg bg-accent b-a-xs"></div>
          <div class="txt-lg ml-md">Pendapatan</div>
        </div> -->
        ...
        <!-- <q-card flat class="bg-accent q-pa-sm mt-sm ">
          <div class="text-center txt-lg">Indicator Pendapatan</div>
        </q-card> -->
        ...
        <!-- <q-card flat class="bg-info q-pa-sm mt-sm ">
          <div class="text-center txt-lg">Indicator Belanja</div>
        </q-card> -->
        <q-list class="mt-md">
...
onMounted(() => {
  const panel = document.getElementsByClassName('my-panel')[0]
